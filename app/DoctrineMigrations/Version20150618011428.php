 ...
 */
class Version20150618011428 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE Category CHANGE catname name VARCHAR(255) NOT NULL");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE Category CHANGE name catName VARCHAR(255) NOT NULL");
